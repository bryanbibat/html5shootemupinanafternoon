...
Once you have setup your web server and text editor, download the [basic game template](https://github.com/bryanbibat/html5shmup-template/archive/master.zip) from Github, extract it to the folder served by the web server, and start coding.
